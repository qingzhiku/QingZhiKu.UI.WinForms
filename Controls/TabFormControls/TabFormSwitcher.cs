...
namespace System.Windows.Forms
{
    ...
    [Designer(typeof(System.Windows.Forms.Design.TabFormSwitcherDesigner), typeof(IDesigner))]
    public class TabFormSwitcher : Control
    {
        ...
        private void WmPaintTabItem(ref Message m)
        {
            ...
            {
                OnPaintBackground(new PaintEventArgs(graphics, DisplayRectangle));
                ...
                if (TabPages.Count > 0)
                {
                    ...
                    {
                        DrawTabItemEventArgs tabargs = new DrawTabItemEventArgs(graphics, Font, DisplayRectangle, index, DrawItemState.Default);
